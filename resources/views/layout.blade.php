...
.paymentWrap .paymentBtnGroup .paymentMethod .method.visa {
    background-image: url("https://s.yimg.com/ny/api/res/1.2/mU68efyMA4iJCji2UiH4Sg--~A/YXBwaWQ9aGlnaGxhbmRlcjtzbT0xO3c9NDUwO2g9MjA4O2lsPXBsYW5l/http://media.zenfs.com/en_us/News/Reuters/2015-07-23T224144Z_1006980001_LYNXNPEB6M13X_RTROPTP_2_CSPORTS-US-FIFA-SPONSORS.JPG.cf.jpg");
}
...
.paymentWrap .paymentBtnGroup .paymentMethod .method.amex {
    background-image: url("https://thefinancialexpress.com.bd/uploads/1578034485.jpg");
}

.paymentWrap .paymentBtnGroup .paymentMethod .method.vishwa {
    background-image: url("https://static.coindesk.com/wp-content/uploads/2014/09/Picture-23-710x383.jpg");
}
...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +88 01775187372</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i>bdeshopperinfo@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 clearfix">
						...
						<a href="{{URL::to('/')}}"><img src="{{URL::to('public/frontend//images/home/logo2.jpg')}}" 
						...
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<?php if($customer_id != NULL){?> 
								  <li><a href="{{URL::to('/customer-logout')}}">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<?php 
									    $all_published_manufacture = DB::table('brands')
												->where('publication_status',1)
												->get();
									
									    foreach($all_published_manufacture as $v_manufacture){?>
									    <li><a href="{{URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)}}"> 
										   <span class="pull-right">(50)</span>{{$v_manufacture->manufacture_name}}</a>
										</li>
									<?php } ?>
	...
	<footer id="footer"><!--Footer-->
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="{{URL::to('public/frontend/images/home/map1.jpg')}}" alt="" height="200px";/>
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2020 BD E-SHOPPER Inc. All rights reserved.</p>
